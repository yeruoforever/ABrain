...
class Render(object):
    ...
    def update_shader_3d(self):
        ...
        glUniform1i(self.ptrs_3d["has_seg"], 1 if self.state.has_seg else 0)
    ...
    def update_texture(self):
        ...
        if self.state.segment_finished.is_set():
            ...
            self.create_texture(None, seg)
            self.state.set_refresh_all()
            self.state.has_seg = True
    ...
    def run(self):
        ...
        if DEBUG:
            self.state.input_file = (
                ...
                "/Users/yeruo/WorkSpace/Datasets/CTCSF/5.0mm/img/20230103001000.nii.gz"
            )
            self.update_texture()
