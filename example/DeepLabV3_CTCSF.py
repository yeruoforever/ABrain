...
class Augment(object):
    ...
    def normalize(self, img: torch.Tensor, seg):
        ...
        img = trsf.normalize(img, [0.485, 0.456, 0.406], [0.229, 0.224, 0.224])
        return img, seg
...
if __name__ == "__main__":
    ...
    model: DeepLabV3 = deeplabv3_resnet50(num_classes=len(label_names))
    # for each in model.backbone.parameters():
    ...
    if not args.inference:
        ...
        ds_test = CT2DDataset(ds, tb_test, use_all=True)
